...
**結論: 現構成はほぼ無料で 1 万人/日までスケールし、10 万人/日のバズでも ~$15/月。** R2 の egress 無料が効いており、GLB 総転送量(バズ時 ~25TB/月!)が課金に一切影響しないのが最大の強み。S3+CloudFront なら同条件で数千ドル級。
...
- `runs/` 37GiB は生の実行成果物。月 $0.5 なので急がないが、wave 3 前に **Infrequent Access($0.01/GB)への移行 or 剪定**で半減可
