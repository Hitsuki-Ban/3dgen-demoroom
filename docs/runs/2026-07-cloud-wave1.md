...
1. Push current TripoSG and PartCrafter images to GHCR and record image digests.
2. Launch one model at a time, verify `bench-harness runpod-pods` after completion, and sync uploaded artifacts into `outputs/site-data/<model-id>/<task-id>/`.
